...
namespace CSharpTest
{
    ...
    public class WorkDayCalculatorTests
    {
        ...
        [TestMethod]
        public void TestWeekendAfterStart()
        {
            DateTime startDate = new DateTime(2017, 4, 21);
            int count = 5;
            WeekEnd[] weekends = new WeekEnd[2]
            {
                new WeekEnd(new DateTime(2017, 4, 22), new DateTime(2017, 4, 25)),
                new WeekEnd(new DateTime(2017, 4, 29), new DateTime(2017, 4, 29))
            };
        ...
        [TestMethod]
        public void TestOneWeekendAfterEnd()
        {
            DateTime startDate = new DateTime(2017, 4, 21);
            int count = 3;
            WeekEnd[] weekends = new WeekEnd[1]
            {
                new WeekEnd(new DateTime(2017, 4, 25), new DateTime(2017, 4, 27))
            };
